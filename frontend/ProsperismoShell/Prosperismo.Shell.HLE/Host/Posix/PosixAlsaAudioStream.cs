...
namespace Prosperismo.HLE.Host.Posix;
...
/// the hardware on bare ALSA setups; PROSPERISMO_ALSA_DEVICE overrides it.
/// </summary>
internal sealed unsafe class PosixAlsaAudioStream : IHostAudioStream
{
    ...
    public PosixAlsaAudioStream(uint sampleRate)
    {
        ...
        var device = Environment.GetEnvironmentVariable("PROSPERISMO_ALSA_DEVICE");
