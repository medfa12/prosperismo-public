...
public static unsafe class GuestImageWriteTracker
{
    ...
    private static readonly bool _enabled =
        Environment.GetEnvironmentVariable("PROSPERISMO_GUEST_IMAGE_CPU_SYNC") != "0";
    private static readonly (bool Wildcard, ulong[] Addresses) _lifetimeTraceFilter =
        ParseAddressList(Environment.GetEnvironmentVariable("PROSPERISMO_TRACE_GUEST_IMAGE_ADDRS"));
    private static readonly (bool Wildcard, string[] Sources) _lifetimeSourceTraceFilter =
        ParseSourceList(Environment.GetEnvironmentVariable("PROSPERISMO_TRACE_GUEST_MEMORY_LIFETIME"));
