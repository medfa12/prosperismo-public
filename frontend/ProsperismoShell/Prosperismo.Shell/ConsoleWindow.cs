...
public sealed class ConsoleWindow : Window
{
        ...
        bool autoScroll)
    {
        ...
        MinWidth = 520;
        MinHeight = 320;
        Background = new SolidColorBrush(Color.Parse("#070A14"));
        Icon = new WindowIcon(AssetLoader.Open(new Uri("avares://Prosperismo.Shell/Assets/Prosperismo.ico")));
        ...
        _list = new ListBox
        {
            ...
            BorderBrush = new SolidColorBrush(Color.Parse("#28304A")),
