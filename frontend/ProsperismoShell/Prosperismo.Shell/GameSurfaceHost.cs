...
public sealed class GameSurfaceHost : NativeControlHost
{
    ...
    protected override IPlatformHandle CreateNativeControlCore(IPlatformHandle control)
    {
        ...
        {
            throw new PlatformNotSupportedException("Prosperismo's embedded Vulkan surface is unsupported on this platform.");
        }
    ...
    {
        _win32ClassName = $"ProsperismoGameSurface-{Guid.NewGuid():N}";
    ...
    private void UpdateSurfaceSize()
    {
        ...
        if (Environment.GetEnvironmentVariable("PROSPERISMO_TRACE_SURFACE_SIZE") == "1")
        {
