...
public sealed class ProsperismoLogger
{
    public ProsperismoLogger(string category)
    {
    ...
    public bool IsEnabled(LogLevel level) => ProsperismoLog.IsEnabled(level);
