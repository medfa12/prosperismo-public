...
struct VulkanInstance {
	...
	bool                               dual_source_blend_enabled         = false;
	bool                               wide_lines_enabled                = false;
	bool                               fill_mode_non_solid_enabled        = false;
	bool conservative_rasterization_enabled                 = false;
	bool conservative_rasterization_underestimation_enabled = false;
	bool conservative_point_line_rasterization_enabled       = false;
	bool                               logic_op_enabled                   = false;
	bool                               depth_bias_clamp_enabled          = false;
