...
uint32_t HwCtxSetPrimitiveResetIndex(CommandProcessor&, uint32_t, uint32_t, const uint32_t*,
                                     uint32_t);
...
uint32_t CpOpAtomicMem(CommandProcessor&, uint32_t, const uint32_t*, uint32_t, uint32_t);
...
uint32_t CpOpCondWrite(CommandProcessor&, uint32_t, const uint32_t*, uint32_t, uint32_t);
