...
constexpr auto MakeContextDispatchTable() {
	...
	g_hw_ctx_func[Pm4::VGT_MULTI_PRIM_IB_RESET_INDX] = HwCtxSetPrimitiveResetIndex;
...
constexpr auto MakeOpcodeDispatchTable() {
	...
	g_cp_op_func[Pm4::IT_ATOMIC_MEM]                = CpOpAtomicMem;
	...
	g_cp_op_func[Pm4::IT_COND_WRITE]                = CpOpCondWrite;
