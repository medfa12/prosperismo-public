...
constexpr OpcodeMap SOP2_OPS[] = {
    ...
    {0x23u, Opcode::SAshrI64},      {0x24u, Opcode::SBfmB32},       {0x25u, Opcode::SBfmB64},
    {0x26u, Opcode::SMulI32},       {0x27u, Opcode::SBfeU32},       {0x28u, Opcode::SBfeI32},
    {0x29u, Opcode::SBfeU64},       {0x2au, Opcode::SBfeI64},
    {0x2cu, Opcode::SAbsDiffI32},   {0x2eu, Opcode::SLshl1AddU32},
    ...
    {0x35u, Opcode::SMulHiU32},     {0x36u, Opcode::SMulHiI32},
};

constexpr OpcodeMap SOP1_OPS[] = {
    {0x03u, Opcode::SMovB32},
    {0x04u, Opcode::SMovB64},
    {0x05u, Opcode::SCmovB32},
    {0x06u, Opcode::SCmovB64},
    {0x07u, Opcode::SNotB32},
    {0x08u, Opcode::SNotB64},
    {0x09u, Opcode::SWqmB32},
    {0x0au, Opcode::SWqmB64},
    {0x0bu, Opcode::SBrevB32},
    {0x0cu, Opcode::SBrevB64},
    {0x0du, Opcode::SBcnt0I32B32},
    {0x0eu, Opcode::SBcnt0I32B64},
    {0x0fu, Opcode::SBcnt1I32B32},
    {0x10u, Opcode::SBcnt1I32B64},
    {0x11u, Opcode::SFf0I32B32},
    {0x12u, Opcode::SFf0I32B64},
    {0x13u, Opcode::SFf1I32B32},
	{0x14u, Opcode::SFf1I32B64},
    {0x15u, Opcode::SFlbitI32B32},
    {0x16u, Opcode::SFlbitI32B64},
    {0x17u, Opcode::SFlbitI32},
    {0x18u, Opcode::SFlbitI32I64},
    {0x19u, Opcode::SSextI32I8},
    {0x1au, Opcode::SSextI32I16},
    ...
    {0x25u, Opcode::SOrSaveexecB64},
    {0x26u, Opcode::SXorSaveexecB64},
    {0x27u, Opcode::SAndn2SaveexecB64},
    {0x28u, Opcode::SOrn2SaveexecB64},
    {0x29u, Opcode::SNandSaveexecB64},
    {0x2au, Opcode::SNorSaveexecB64},
    {0x2bu, Opcode::SXnorSaveexecB64},
    {0x2cu, Opcode::SQuadMaskB32},
    {0x2du, Opcode::SQuadMaskB64},
    {0x34u, Opcode::SAbsI32},
    {0x37u, Opcode::SAndn1SaveexecB64},
    {0x38u, Opcode::SOrn1SaveexecB64},
    {0x3bu, Opcode::SBitreplicateB64B32},
    {0x3cu, Opcode::SAndSaveexecB32},
    {0x3du, Opcode::SOrSaveexecB32},
    {0x3eu, Opcode::SXorSaveexecB32},
    {0x3fu, Opcode::SAndn2SaveexecB32},
    {0x40u, Opcode::SOrn2SaveexecB32},
    {0x41u, Opcode::SNandSaveexecB32},
    {0x42u, Opcode::SNorSaveexecB32},
    {0x43u, Opcode::SXnorSaveexecB32},
    {0x44u, Opcode::SAndn1SaveexecB32},
    {0x45u, Opcode::SOrn1SaveexecB32},
};
...
constexpr OpcodeMap SOPC_OPS[] = {
    ...
    {0x0cu, Opcode::SBitcmp0B32}, {0x0du, Opcode::SBitcmp1B32}, {0x0eu, Opcode::SBitcmp0B64},
    {0x0fu, Opcode::SBitcmp1B64},
    {0x12u, Opcode::SCmpEqU64},   {0x13u, Opcode::SCmpLgU64},
};

constexpr OpcodeMap SOPK_OPS[] = {
    {0x00u, Opcode::SMovkI32},   {0x02u, Opcode::SCmovkI32},
    {0x03u, Opcode::SCmpEqI32},  {0x04u, Opcode::SCmpLgI32},
...
bool DecodeSopk(uint32_t pc, std::span<const uint32_t> code, uint32_t word_index, Instruction& inst,
	...
	switch (inst.opcode) {
		case Opcode::SMovkI32:
		case Opcode::SCmovkI32: return DecodeScalarDestination(sdst, pc, inst.dst, error);
