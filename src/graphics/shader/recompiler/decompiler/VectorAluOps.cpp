...
constexpr OpcodeMap VOP1_OPS[] = {
    ...
    {0x65u, Opcode::VSwapB32},
    {0x68u, Opcode::VSwaprelB32},
    ...
    {0x5fu, Opcode::VFractF16},
    {0x60u, Opcode::VSinF16},
    {0x61u, Opcode::VCosF16},
    {0x62u, Opcode::VSatPkU8I16},
};
...
constexpr OpcodeMap VOP3_OPS[] = {
    ...
    {0x14du, Opcode::VLerpU8},          {0x14eu, Opcode::VAlignbitB32},
    {0x14fu, Opcode::VAlignbyteB32},
    {0x151u, Opcode::VMin3F32},
    ...
    {0x357u, Opcode::VMed3F16},         {0x15au, Opcode::VSadU8},
    {0x15bu, Opcode::VSadHiU8},         {0x15cu, Opcode::VSadU16},
    {0x15du, Opcode::VSadU32},          {0x171u, Opcode::VMsadU8},
    {0x172u, Opcode::VQsadPkU16U8},
    {0x173u, Opcode::VMqsadPkU16U8},
    ...
    {0x16cu, Opcode::VMulHiI32},        {0x2ffu, Opcode::VLshlrevB64},
    {0x300u, Opcode::VLshrrevB64},      {0x301u, Opcode::VAshrrevI64},
    {0x303u, Opcode::VAddNcU16},
    ...
    {0x344u, Opcode::VPermB32},         {0x345u, Opcode::VXadU32},
    {0x346u, Opcode::VLshlAddU32},
...
constexpr Vop1SdwaRule VOP1_SDWA_RULES[] = {
    ...
    {Opcode::VRndneF16, SdwaSelWords() | SdwaSelFull(), SdwaSelWords(),
     SdwaSelWords() | SdwaSelFull(), false},
    {Opcode::VFractF16, SdwaSelWords() | SdwaSelFull(), SdwaSelWords(),
     SdwaSelWords() | SdwaSelFull(), false},
    {Opcode::VSinF16, SdwaSelWords() | SdwaSelFull(), SdwaSelWords(),
     SdwaSelWords() | SdwaSelFull(), false},
    {Opcode::VCosF16, SdwaSelWords() | SdwaSelFull(), SdwaSelWords(),
     SdwaSelWords() | SdwaSelFull(), false},
...
uint32_t NativeVop3SourceCount(Opcode opcode) {
	switch (opcode) {
		...
		case Opcode::VLshlrevB64:
		case Opcode::VLshrrevB64:
		case Opcode::VAshrrevI64:
		case Opcode::VAddI32:
		case Opcode::VSubI32:
...
bool HasUnsupportedNativeVop3Modifiers(Opcode opcode, bool permlane, bool mad_mix, bool addc,
	...
	switch (opcode) {
		...
		case Opcode::VAlignbyteB32:
			return abs != 0u || (op_sel & ~0x3u) != 0u || clamp != 0u || omod != 0u ||
			       neg != 0u;
		case Opcode::VCndmaskB32:
...
bool DecodeVop3(uint32_t pc, std::span<const uint32_t> code, uint32_t word_index, Instruction& inst,
	...
	} else if (inst.opcode == Opcode::VAlignbyteB32) {
		inst.src2.op_sel    = (op_sel & 0x1u) != 0u;
		inst.src2.op_sel_hi = (op_sel & 0x2u) != 0u;
