...
std::string InstructionToString(const Instruction& inst) {
	...
	switch (inst.op) {
		...
		case Opcode::SwapU32: text += "SwapU32"; break;
		case Opcode::SwapRelU32: text += "SwapRelU32"; break;
		...
		case Opcode::WqmB32: text += "WqmB32"; break;
		case Opcode::WqmB64: text += "WqmB64"; break;
		case Opcode::QuadMaskB32: text += "QuadMaskB32"; break;
		case Opcode::QuadMaskB64: text += "QuadMaskB64"; break;
		...
		case Opcode::BitClearU64: text += "BitClearU64"; break;
		case Opcode::BitSetU32: text += "BitSetU32"; break;
		case Opcode::BitSetU64: text += "BitSetU64"; break;
		case Opcode::BitReverseU32: text += "BitReverseU32"; break;
		case Opcode::BitReverseU64: text += "BitReverseU64"; break;
		case Opcode::BitCountZeroU32: text += "BitCountZeroU32"; break;
		case Opcode::BitCountZeroU64: text += "BitCountZeroU64"; break;
		...
		case Opcode::FindLsbZeroU32: text += "FindLsbZeroU32"; break;
		case Opcode::FindLsbZeroU64: text += "FindLsbZeroU64"; break;
		...
		case Opcode::FindMsbSignI32: text += "FindMsbSignI32"; break;
		case Opcode::FindMsbSignI64: text += "FindMsbSignI64"; break;
		case Opcode::SignExtendI8U32: text += "SignExtendI8U32"; break;
		case Opcode::SignExtendI16U32: text += "SignExtendI16U32"; break;
		...
		case Opcode::BitFieldExtractI64: text += "BitFieldExtractI64"; break;
		...
		case Opcode::BitCompare0B64: text += "BitCompare0B64"; break;
		case Opcode::BitCompare1B64: text += "BitCompare1B64"; break;
		case Opcode::AlignBitU32: text += "AlignBitU32"; break;
		case Opcode::AlignByteU32: text += "AlignByteU32"; break;
		case Opcode::PermuteBytesU32: text += "PermuteBytesU32"; break;
		case Opcode::MeanBytesU32: text += "MeanBytesU32"; break;
		case Opcode::SadBytesU32: text += "SadBytesU32"; break;
		case Opcode::SadBytesHighU32: text += "SadBytesHighU32"; break;
		case Opcode::MaskedSadBytesU32: text += "MaskedSadBytesU32"; break;
		case Opcode::QuadSadPackedU16U8: text += "QuadSadPackedU16U8"; break;
		case Opcode::MaskedQuadSadPackedU16U8: text += "MaskedQuadSadPackedU16U8"; break;
		case Opcode::SadWordsU32: text += "SadWordsU32"; break;
		...
		case Opcode::ShiftRightArithmeticI64: text += "ShiftRightArithmeticI64"; break;
		...
		case Opcode::SinF16: text += "SinF16"; break;
		case Opcode::CosF16: text += "CosF16"; break;
		case Opcode::SaturatePackU8I16: text += "SaturatePackU8I16"; break;
