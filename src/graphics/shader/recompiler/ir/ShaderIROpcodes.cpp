...
constexpr LowerMap LOWER_OPS[] = {
    ...
    {Decoder::Opcode::VSwapB32, Opcode::SwapU32},
    {Decoder::Opcode::VSwaprelB32, Opcode::SwapRelU32},
    {Decoder::Opcode::SMovB64, Opcode::MoveU64},
    {Decoder::Opcode::SWqmB32, Opcode::WqmB32},
    {Decoder::Opcode::SWqmB64, Opcode::WqmB64},
    {Decoder::Opcode::SQuadMaskB32, Opcode::QuadMaskB32},
    {Decoder::Opcode::SQuadMaskB64, Opcode::QuadMaskB64},
    {Decoder::Opcode::SMovkI32, Opcode::MoveU32},
    {Decoder::Opcode::SAbsI32, Opcode::AbsI32},
    {Decoder::Opcode::SAbsDiffI32, Opcode::AbsDiffI32},
    {Decoder::Opcode::SBrevB32, Opcode::BitReverseU32},
    {Decoder::Opcode::SBrevB64, Opcode::BitReverseU64},
    {Decoder::Opcode::SBcnt0I32B32, Opcode::BitCountZeroU32},
    {Decoder::Opcode::SBcnt0I32B64, Opcode::BitCountZeroU64},
    {Decoder::Opcode::SBcnt1I32B32, Opcode::BitCountU32},
    {Decoder::Opcode::SBcnt1I32B64, Opcode::BitCountU64},
    {Decoder::Opcode::SFf0I32B32, Opcode::FindLsbZeroU32},
    {Decoder::Opcode::SFf0I32B64, Opcode::FindLsbZeroU64},
    {Decoder::Opcode::SFf1I32B32, Opcode::FindLsbU32},
	{Decoder::Opcode::SFf1I32B64, Opcode::FindLsbU64},
    {Decoder::Opcode::SFlbitI32B32, Opcode::FindMsbFromHighU32},
    {Decoder::Opcode::SFlbitI32B64, Opcode::FindMsbFromHighU64},
    {Decoder::Opcode::SFlbitI32, Opcode::FindMsbSignI32},
    {Decoder::Opcode::SFlbitI32I64, Opcode::FindMsbSignI64},
    {Decoder::Opcode::SSextI32I8, Opcode::SignExtendI8U32},
    {Decoder::Opcode::SSextI32I16, Opcode::SignExtendI16U32},
    ...
    {Decoder::Opcode::SAshrI64, Opcode::ShiftRightArithmeticI64},
    ...
    {Decoder::Opcode::SBfeI64, Opcode::BitFieldExtractI64},
    ...
    {Decoder::Opcode::SBitcmp0B64, Opcode::BitCompare0B64},
    {Decoder::Opcode::SBitcmp1B64, Opcode::BitCompare1B64},
    ...
    {Decoder::Opcode::VFractF16, Opcode::FractF16},
    {Decoder::Opcode::VSinF16, Opcode::SinF16},
    {Decoder::Opcode::VCosF16, Opcode::CosF16},
    {Decoder::Opcode::VSatPkU8I16, Opcode::SaturatePackU8I16},
    ...
    {Decoder::Opcode::VFfbhI32, Opcode::FindMsbSignI32},
    ...
    {Decoder::Opcode::VFmaF32, Opcode::FFmaF32},
    ...
    {Decoder::Opcode::VPermB32, Opcode::PermuteBytesU32},
    {Decoder::Opcode::VLerpU8, Opcode::MeanBytesU32},
    {Decoder::Opcode::VSadU8, Opcode::SadBytesU32},
    {Decoder::Opcode::VSadHiU8, Opcode::SadBytesHighU32},
    {Decoder::Opcode::VMsadU8, Opcode::MaskedSadBytesU32},
    {Decoder::Opcode::VQsadPkU16U8, Opcode::QuadSadPackedU16U8},
    {Decoder::Opcode::VMqsadPkU16U8, Opcode::MaskedQuadSadPackedU16U8},
    {Decoder::Opcode::VSadU16, Opcode::SadWordsU32},
    ...
    {Decoder::Opcode::VLshrrevB64, Opcode::ShiftRightLogicalU64},
    ...
    {Decoder::Opcode::VAshrrevI64, Opcode::ShiftRightArithmeticI64},
    ...
    {Decoder::Opcode::ImageBvhIntersectRay, Opcode::ImageBvhIntersectRay},
};
...
bool IsReversedBinary(Decoder::Opcode opcode) {
	switch (opcode) {
		...
		case Decoder::Opcode::VLshrrevB64:
		case Decoder::Opcode::VAshrrevI32:
		case Decoder::Opcode::VAshrrevI64:
...
bool ScalarResultWritesSccNonZero(Decoder::Opcode opcode) {
	switch (opcode) {
		...
		case Decoder::Opcode::SBcnt0I32B32:
		case Decoder::Opcode::SBcnt0I32B64:
		...
		case Decoder::Opcode::SAshrI64:
		case Decoder::Opcode::SBfeU64:
		case Decoder::Opcode::SBfeI64:
		case Decoder::Opcode::SWqmB32:
		case Decoder::Opcode::SWqmB64:
		case Decoder::Opcode::SQuadMaskB32:
		case Decoder::Opcode::SQuadMaskB64: return true;
		default: return false;
	}
}
