...
struct EmitterState {
	...
	uint32_t                                         ptr_input_sample_mask_array  = 0;
...
void CollectRelativeVectorRegisters(const IR::Program&            program,
                                    std::vector<RegisterBinding>& registers);
...
void EmitSLoadDwordGroup(EmitterState& state, const IR::Instruction* instructions, uint32_t count);
