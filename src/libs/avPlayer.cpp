...
static_assert(sizeof(AvPlayerInitDataEx) == 0x230);
...
public:
	...
	int StreamCount() const {
		...
		return VisibleStreamCount(
		    streams_available, fmt == nullptr ? 0 : static_cast<int>(fmt->nb_streams));
	}
