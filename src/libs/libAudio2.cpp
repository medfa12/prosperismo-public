...
static constexpr int AUDIO_OUT2_ERROR_INVALID_SAMPLE_FREQ         = -2144960502; /* 0x8026800a */
...
int KYTY_SYSV_ABI AudioOut2PortCreate(AudioOut2ContextHandle ctx, const AudioOut2PortParam* params,
	...
	if (params->sampling_freq != 48000) {
		return AUDIO_OUT2_ERROR_INVALID_SAMPLE_FREQ;
	}
