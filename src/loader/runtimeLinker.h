...
struct Program {
	...
	RuntimeLinkerLifecycle::ModuleReferenceState load_references;
...
public:
	...
	bool AddProgramLoadReference(Program* program);
	RuntimeLinkerLifecycle::ModuleReleaseAction PrepareProgramUnload(Program* program);
